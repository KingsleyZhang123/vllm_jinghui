...
class ModelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        has_interleaved_attention = (sliding_window is not None) and (
            ...
            or (self.hf_text_config.model_type in interleaved_attn_models)
        )
        ...
        if quant_cfg is not None:
            ...
            for name in quantization_methods:
                ...
                if quantization_override is not None:
                    ...
                    if name in get_args(QuantizationMethods) and name not in overrides:
                        raise ValueError(
...
class SchedulerConfig:
    ...
    def __post_init__(self) -> None:
        if self.max_model_len is None:
            ...
            logger.warning_once(
                "max_model_len was is not set. Defaulting to arbitrary value " "of %d.",
                self.max_model_len,
            )
        ...
        if self.max_num_seqs is None:
            ...
            logger.warning_once(
                "max_num_seqs was is not set. Defaulting to arbitrary value " "of %d.",
                self.max_num_seqs,
            )
...
class SpeculativeConfig:
    ...
    target_parallel_config: ParallelConfig = field(
    ...
    draft_parallel_config: ParallelConfig = field(
        default=None, init=True
    )  # type: ignore
    ...
    def __post_init__(self):
        ...
        if self.model is None and self.num_speculative_tokens is not None:
            ...
            if (
                ...
                and self.target_model_config.hf_text_config.model_type == "deepseek_v3"
            ):
                ...
                raise ValueError(
                    "num_speculative_tokens was provided without " "speculative model."
                )
        ...
        if self.method in ("ngram", "[ngram]"):
            ...
            if self.model is not None:
                ...
                if self.method in ("eagle", "eagle3"):
                    ...
                    if (
                        isinstance(self.draft_model_config.hf_config, EAGLEConfig)
    ...
    def _verify_args(self) -> None:
        ...
        if self.acceptance_method == "typical_acceptance_sampler" and (
            (self.posterior_threshold is not None and self.posterior_threshold < 0)
    ...
    if isinstance(dtype, str):
        ...
        if dtype == "auto":
            ...
            if torch_dtype not in current_platform.supported_dtypes:
                ...
                if (capability := current_platform.get_device_capability()) is None:
                    compute_str = ""
                else:
...
class KVTransferConfig:
    ...
    kv_connector_external_registeration_args: Optional[dict[str, Any]] = None
    """Optional args to register external kv connectors."""
...
class PassConfig:
    ...
    def uuid(self):
        ...
        compilation.
        """
        include = {"enable_fusion", "enable_noop", "enable_sequence_parallelism"}
...
class CompilationConfig:
    ...
    bs_to_padded_graph_size: list[int] = field(default=None, init=False)  # type: ignore
    """optimization:
...
class VllmConfig:
    ...
    def __post_init__(self):
        ...
        if (
            ...
            and self.compilation_config.pass_config is not None
            ...
            self.compilation_config.pass_config.enable_sequence_parallelism = False
